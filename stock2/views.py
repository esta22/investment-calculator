    ...
    def run_investment_simulation(self, ticker, ticker2, initial_capital, monthly_investment,
            ...
            if not purchased:
                ...
                if ticker:
                    ...
                    if stock_price1:
                        ...
                        investment_ratio = monthly_investment / (
                                    monthly_investment + monthly_investment2) if monthly_investment2 > 0 else 1.0
                        shares_to_buy1 = int((cash_krw * investment_ratio) // stock_price_krw1)  # 소수점 제거
                        ...
                        if shares_to_buy1 > 0:
                            ...
                            records.append({
                                ...
                                'shares_bought': shares_to_buy1,  # 정수로 저장
                                'shares_held': shares_held[ticker],  # 정수로 저장
                ...
                if ticker2:
                    ...
                    if stock_price2 and cash_krw > 0:
                        ...
                        shares_to_buy2 = int(cash_krw // stock_price_krw2)  # 소수점 제거
                        ...
                        if shares_to_buy2 > 0:
                            ...
                            records.append({
                                ...
                                'shares_bought': shares_to_buy2,  # 정수로 저장
                                'shares_held': shares_held[ticker2],  # 정수로 저장
        ...
        for t, shares in shares_held.items():
            ...
            if end_price:
                ...
                # 각 티커별 상세 정보 저장 (소수점 제거)
                ticker_details[t] = {
                    'shares': int(shares),  # 정수로 저장
        ...
        return {
            ...
            'final_result': {
                ...
                'ticker_details': ticker_details  # 각 티커별 상세 정보
            }
        }
